  ...
  return (
    <div className="flex flex-col gap-8 p-8">
      <header className="flex flex-col gap-2">
        <p className="billio-label">取引先</p>
      ...
      <section className="billio-card p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p className="billio-label mb-1">登録済み取引先</p>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-billio-border-subtle">
              {clients.length === 0 ? (
                ...
                clients.map((client) => (
                  <tr key={client.id} className="text-billio-text-muted">
                    <td className="px-4 py-4 font-medium text-billio-text">
                      {client.name}
                    </td>
