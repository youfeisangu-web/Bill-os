...
export function translateErrorMessage(message: string): string {
  const translations: Record<string, string> = {
    ...
    "timeout": "タイムアウトが発生しました。ファイルサイズが大きすぎる可能性があります。",
    "タイムアウト": "処理に時間がかかりすぎました。ファイルサイズを小さくするか、画像の解像度を下げて再試行してください。",
    "タイムアウトしました": "処理に時間がかかりすぎました。ファイルサイズを小さくするか、画像の解像度を下げて再試行してください。",
